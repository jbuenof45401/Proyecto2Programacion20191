...
class pruebas(unittest.TestCase):
    def test_corresponden(self):
        ...
        self.assertRaises(TypeError,ADN.corresponden(ATACA, ZPQW), 'Alguna cadena no es valida')
    def test_es_cadena_valida(self):
        ...
        self.assertRaises(TypeError,ADN.es_cadena_valida(COMBO), 'Ingrese una cadena valida')
    def test_es_base(self):
        ...
        self.assertRaises(TypeError,ADN.es_base(DRE), 'DRE tiene más de un caracter')
    def test_es_subcadena(self):
        ...
        self.assertRaises(TypeError,ADN.es_subcadena(ATCT, DQ), 'Las cadenas no son validas')
