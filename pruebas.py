...
class pruebas(unittest.TestCase):
    def test_corresponden(self):
        ...
        self.assertRaises(TypeError,ADN.corresponden, 'Alguna cadena no es valida')
    def test_es_cadena_valida(self):
        ...
        self.assertRaises(TypeError,ADN.es_cadena_valida, 'Ingrese una cadena valida')
    def test_es_base(self):
        ...
        self.assertRaises(TypeError,ADN.es_base, 'DRE tiene más de un caracter')
    def test_es_subcadena(self):
        ...
        self.assertRaises(TypeError,ADN.es_subcadena, 'Las cadenas no son validas')
